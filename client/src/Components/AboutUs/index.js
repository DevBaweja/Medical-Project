	...
	render() {
		return (
			<div className="about-us">
				...
				<div className="container about-us_main">
					<div className="row about-us_intro">
						...
						<div className="col about-svg">
							<img className="about-svg_svg" src={aboutSvg} alt="" />
						</div>
					</div>
					<div className="row">
						<div className="col">
							<div class="about-us_card">
								<img src={doctor} class="about-card_icon" />
						...
						<div className="col">
							<div class="about-us_card">
								<img src={member} class="about-card_icon" />
						...
						<div className="col">
							<div class="about-us_card">
								<img src={rating} class="about-card_icon" />
				...
				<div className="container efy">
					...
					<div className="row efy-box">
						...
						<div className="col efy-svg text-center">
							<img src={solution} class="efy-svg_svg" />
						</div>
					</div>
					<div className="row efy-box">
						<div className="col efy-svg text-center">
							<img src={testimonials} class="efy-svg_svg" />
						</div>
						<div className="col efy-content">
					...
					<div className="row efy-box">
						...
						<div className="col efy-svg text-center">
							<img src={therapist} class="efy-svg_svg" />
						</div>
					</div>
					<div className="row efy-box">
						<div className="col efy-svg text-center">
							<img src={target} class="efy-svg_svg" />
						</div>
						<div className="col efy-content">
